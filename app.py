...
# st.write("This app predicts whether a person has Autism Spectrum Disorder (ASD) based on user inputs.")

# # ------------------------------
# # Input fields
# # ------------------------------

# # 10 A-score questions (0 or 1)
# A_scores = {}
# for i in range(1, 11):
...
# autism = st.selectbox("Autism in Family?", ["yes", "no"])
...
#     if prediction == 0:
#         st.error("🚨 The person **HAS ASD**")
#     else:
#         st.success("✅ The person **does NOT have ASD**")
import streamlit as st
import numpy as np
import pickle
import pandas as pd
